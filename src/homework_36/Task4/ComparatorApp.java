 ...
 */
package homework_36.Task4;

import lesson_36.CarModelComparator;
import lesson_36.CarSpeedComparator;
...
//         Статические методы интерфейса Comparator
        ...
        System.out.println("***********************\n");
        // Отсортировать машины по году выпуска, если год равен - отсортировать по максимальной скорости в порядке возрастания
        Arrays.sort(cars, Comparator.comparing(Car::getYear).thenComparing(Car::getMaxSpeed, Comparator.naturalOrder()));
        System.out.println(Arrays.toString(cars));
        System.out.println("***********************\n");
    }
}