...
public class CollectionExample {
    ...
    public static void main(String[] args) {
        ...
        //toString - Переопределенный метод toString для красивого вывода элементов коллекции
        System.out.println(strings);

        // Метод .of() - создает неизменяемую коллекцию. Это статический метод в нескольких интерфейсах и классах. Был введен в Java 9
...
//        integers.add(7); // попытка модифицировать (изменить) неизменяемую коллекцию приведет в ошибку (Исключительная ситуация)
       ...
       */
        ...
        // addAll(Collection<? extends T> col) - добавляет все эл-ты из указанной коллекции.(СЛОЖЕНИЕ)
        ...
        numbers.addAll(List.of(0, 1, 2, 3, 5, 3, 3, 3));
        ...
        colA.addAll(List.of(10, 20, 30 , 20, 40, 50, 60, 40, 40 , 40, 40));
